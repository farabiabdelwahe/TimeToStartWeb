...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pidev', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\User\\UserBundle\\Entity'))), 'User\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('UserUserBundle' => 'User\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bbd96d1e6db3965a46e930a8457dbc500f7d50089bf077a0b33b31ca2046243a');
        return $instance;
    }
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'raid.raddaoui@gmail.com'), array());
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.single_address' => 'raid.raddaoui@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'raid.raddaoui@gmail.com',
            ),
            'swiftmailer.mailer.default.delivery_whitelist' => array(
            ),
            'swiftmailer.spool.enabled' => false,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'raid.raddaoui@gmail.com',
