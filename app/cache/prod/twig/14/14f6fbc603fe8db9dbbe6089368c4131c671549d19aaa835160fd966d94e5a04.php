...
class __TwigTemplate_9308eda93bc860e50b920ab1aafc74ef53e897814ae540b3e1667af902650fb6 extends Twig_Template
{
...
<html>
    ...
    <body>
        ...
        if ($this->env->getExtension('security')->isGranted("IS_AUTHENTICATED_REMEMBERED")) {
            // line 9
            echo "                ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("logged_in", array("%username%" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "username", array())), "FOSUserBundle"), "html", null, true);
            echo " |
                <a href=\"";
            // line 10
...
/*                 {{ 'logged_in' |trans({'%username%': app.user.username}, 'FOSUserBundle') }} |*/
