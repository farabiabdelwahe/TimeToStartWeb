...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\User\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\TimeToStart\\ProjectBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'User\\UserBundle\\Entity');
        $c->addDriver($b, 'TimeToStart\\ProjectBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserUserBundle' => 'User\\UserBundle\\Entity', 'TimeToStartProjectBundle' => 'TimeToStart\\ProjectBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1977dd174f863bb4e525e4e7f23b4a51d683b75a70da980f9e6512891f071493');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'User\\UserBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \User\UserBundle\Redirection\AfterLoginRedirection A User\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \User\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/change-password$');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/edit');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/affichage');
        ...
        $n->add($m, array(0 => 'ROLE_CLIENT'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('raid.raddaoui@gmail.com');
        $a->setPassword('raid20066789farabi');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\UserBundle/Resources/views'), 'UserUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\TimeToStart\\ProjectBundle/Resources/views'), 'TimeToStartProject');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TimeToStartProjectBundle' => 'TimeToStart\\ProjectBundle\\TimeToStartProjectBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'raid.raddaoui@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'raid20066789farabi',
            ...
            'fos_user.model.user.class' => 'User\\UserBundle\\Entity\\User',
